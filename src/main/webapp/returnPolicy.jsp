...
<body>
    ...
    <div class="container">
        <header>
            ...
            <p>We want you to be satisfied with your purchase. If you need to make a return or cancel an order, please
                read our policy below to understand the process.</p>
        </header>
        ...
        <section class="policy-details">
            ...
            <ul>
                <li>You will be charged the delivery fee and</li>
                <li>You will be required to pay <b>half of the total order amount </b> as a cancellation fee.</li>
            </ul>
            ...
            <ul>
                ...
                <li><strong>Contact Form:</strong> <a href="contact.jsp">Click here to contact us</a></li>
            </ul>
        </section>
